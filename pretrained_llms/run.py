...
def main() -> None:
    ...
    if not bool(config.get("skip_train", False)):
        ...
        training_config = TrainingConfig(
            ...
            muon_aux_lr=float(config.get("muon_aux_lr", 3e-4)),
            ...
            kl_anchor_jsonl=(str(config["kl_anchor_jsonl"]) if config.get("kl_anchor_jsonl") else None),
            kl_batch_size=int(config.get("kl_batch_size", 8)),
